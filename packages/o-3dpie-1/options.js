...
export default async function (id, data, config) {
	await loadJs('http://cdn.highcharts.com.cn/highcharts/9.0.1/highcharts.js', 'Highcharts')
	await loadJs('http://eslinkv.eslink.cc/cdn/highcharts/highcharts-3d-9.0.1.js', 'Highcharts1')
	await loadJs('http://eslinkv.eslink.cc/cdn/highcharts/highcharts-zh_CN.js', 'Highcharts3')
	if (!data) return
	...
	const chart = Highcharts.chart(id, {
		...
		title: {
			...
			style:{color:'#fff','font-size':'32px','font-family': 'font-num'}
		},
		subtitle: {
			text: arr[0].name,
			verticalAlign: 'middle',
